...
func _ready():
	...
	_populate_viewport(viewport, "res://scenes/credits.tscn")
	_populate_viewport(viewport_right, "res://scenes/charge_megacharge1.tscn")
	_populate_viewport(viewport_left, "res://scenes/charge.tscn")
